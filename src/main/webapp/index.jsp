...
<h1>와이파이 정보 구하기</h1>
<br>
<a href="index.jsp">홈</a> | <a href="history.jsp">위치 히스토리 목록</a> | <a href="load-wifi.jsp">Open API 와이파이 정보
    가져오기</a>
<br>
<br>
...
%>
    <tr>
        ...
        <td><%=wi.getX_SWIFI_MGR_NO()%>
        </td>
        <td><%=wi.getX_SWIFI_WRDOFC()%>
        </td>
        <td><%=wi.getX_SWIFI_MAIN_NM()%>
        </td>
        <td><%=wi.getX_SWIFI_ADRES1()%>
        </td>
        <td><%=wi.getX_SWIFI_ADRES2()%>
        </td>
        <td><%=wi.getX_SWIFI_INSTL_FLOOR()%>
        </td>
        <td><%=wi.getX_SWIFI_INSTL_TY()%>
        </td>
        <td><%=wi.getX_SWIFI_INSTL_MBY()%>
        </td>
        <td><%=wi.getX_SWIFI_SVC_SE()%>
        </td>
        <td><%=wi.getX_SWIFI_CMCWR()%>
        </td>
        <td><%=wi.getX_SWIFI_CNSTC_YEAR()%>
        </td>
        <td><%=wi.getX_SWIFI_INOUT_DOOR()%>
        </td>
        <td><%=wi.getX_SWIFI_REMARS3()%>
        </td>
        <td><%=wi.getLAT()%>
        </td>
        <td><%=wi.getLNT()%>
